    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h1 className="text-center text-2xl font-bold bg-gradient-to-r from-primary-600 via-orange-500 to-brown-700 bg-clip-text text-transparent">Fresh Corner</h1>
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            {errors.general && (
              <div className="mb-4 bg-red-50 p-4 rounded-md flex items-center">
                <AlertCircle className="h-5 w-5 text-red-600 mr-3" aria-hidden="true" />
